...
const paths: Record<IconName, string[]> = {
  ...
  camera: ['M4 8h3l2-3h6l2 3h3v11H4V8Z', 'M12 17a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z'],
  ...
  share: ['M18 8a3 3 0 1 0-2.8-4H15a3 3 0 0 0 1 2.2l-8.1 4.7a3 3 0 1 0 0 2.2l8.1 4.7a3 3 0 1 0 1-1.7l-8.1-4.7 8.1-4.7c.4.7 1.1 1.1 2 1.1Z'],
  ...
  volumeOff: ['M4 9v6h4l5 4V5L8 9H4Z', 'm19 9-6 6', 'm13 9 6 6'],
};
